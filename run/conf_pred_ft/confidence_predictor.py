...
def train():
    ...
    for epoch_i in range(0, epochs):
        ...
        if avg_val_accuracy > best_val_accuracy:
            ...
            torch.save(model.state_dict(), '../../finetuned_models/confidence_best_model_state.bin')
...
def flat_confidence(preds):
    ...
    return predicted_confidence[:,1].flatten()
...
_, _, test_dataloader = ret_dataloader()
...
predicted_confidence = flat_confidence(torch.tensor(predicted_logits))